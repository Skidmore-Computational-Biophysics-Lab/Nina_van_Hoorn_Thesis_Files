...
encoder.save('trained_encoder_epochs-'+str(epochs)+'.keras')
decoder.save('trained_decoder_epochs-'+str(epochs)+'.keras')
autoencoder.save('trained_autoencoders_epochs-'+str(epochs)+'.keras')
